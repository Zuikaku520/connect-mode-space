...
scan_dict = {
    ...
    'Delayed+Recurrent': list(zip(combo_delay_vals, combo_gain_vals)),
    'Delayed+Gated': list(zip(combo_delay_vals, combo_inhib_vals)),
    'Recurrent+Gated': list(zip(combo_gain_vals, combo_inhib_vals)),
    'Delayed+Recurrent+Gated': list(zip(combo_delay_vals, combo_gain_vals, combo_inhib_vals)),
}
